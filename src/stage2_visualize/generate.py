...
SECOND_STATION_NAME = "stage2_visualize"
...
class IIDLabelComparator:
	def __init__(self, station_dir: Path):
		...
		self.input_root = station_dir / "data"
		self.output_root = station_dir / "charts"
	...
	def load(self) -> None:
		...
		for batch_dir in batch_dirs:
			...
			for run_dir in sorted(run_root.iterdir()):
				...
				distribution = meta.get("distribution", "").lower()
