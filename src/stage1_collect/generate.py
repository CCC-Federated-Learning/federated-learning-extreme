...
FIRST_STATION_NAME = "stage1_collect"
...
class StrategyAnalyzer:
    ...
    def _build_chart_context(self) -> str:
        ...
        datasets = [data.get('dataset', '') for data in self.strategy_data.values()]
    ...
    def _load_all_data(self):
        ...
        for subdir in sorted(self.data_dir.iterdir()):
            ...
            with open(metadata_path, 'r') as f:
                ...
                distribution = self._normalize_distribution(self._metadata_value(content, 'distribution'))
                dataset_name = self._metadata_value(content, 'dataset')
