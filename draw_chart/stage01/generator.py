...
COLORS = {
    ...
    'dp_client_adaptive': '#ff9999',
    'dp_client_fixed': '#ffcc99',
    'dp_server_adaptive': '#99ccff',
    'dp_server_fixed': '#cc99ff',
    'FedXgbBagging': '#99ff99', 'FedXgbCyclic': '#ffff99',
    'QFedAvg': '#00ffff'
}

DP_SHORT_NAMES = {
    'dp_client_adaptive': 'DP-Client-Adaptive',
    'dp_client_fixed': 'DP-Client-Fixed',
    'dp_server_adaptive': 'DP-Server-Adaptive',
    'dp_server_fixed': 'DP-Server-Fixed',
}
