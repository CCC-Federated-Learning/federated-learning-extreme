...
def main() -> int:
	...
	safe_dirs = {
		"PUT-DATA-THERE",
		"generate_charts",
		"recieve_from_stage01",
		"clearner.py",  # Script itself
		"generator.py",  # Script itself
		"move_to_stage03.py",  # Script itself
	...
	# First: Clear contents of PUT-DATA-THERE, generate_charts, and recieve_from_stage01
	print("\n🧹 Clearing directory contents...")
	targets_to_clear = [
		base_dir / "PUT-DATA-THERE",
		base_dir / "generate_charts",
		base_dir / "recieve_from_stage01",
	]
	...
	# Second: Remove other files/folders in stage02
