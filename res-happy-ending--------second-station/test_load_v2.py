...
base = Path("PUT-DATA-THERE/label-Round-200-Epoch-3-20260322-2312-59/PUT-DATA-THERE")
...
for strat_dir in strategies:
    csv_path = base / strat_dir / "run_metrics.csv"
    json_path = base / strat_dir / "run_metrics.json"
